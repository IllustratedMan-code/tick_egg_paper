...
export declare type Conditional<CD extends FieldDef<any> | DatumDef | ValueDef<any> | ExprRef | SignalRef> = ConditionalPredicate<CD> | ConditionalParameter<CD>;
...
export declare type ConditionalParameter<CD extends FieldDef<any> | DatumDef | ValueDef<any> | ExprRef | SignalRef> = ParameterPredicate & CD;
export declare function isConditionalParameter<T>(c: Conditional<T>): c is ConditionalParameter<T>;
