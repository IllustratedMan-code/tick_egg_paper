...
async function ensurePackage(options) {
    ...
    if (usesTS) {
        if (cssImports.length > 0 ||
            ...
            if (fs.existsSync(path.join(pkgPath, 'style')) &&
                fs
    ...
    if ((_d = data.scripts) === null || _d === void 0 ? void 0 : _d.prepublishOnly) {
    ...
    const buildScript = ((_e = data.scripts) === null || _e === void 0 ? void 0 : _e.build) || '';
    if (buildScript &&
