 ...
 */
export declare const ILoggerRegistry: Token<ILoggerRegistry>;
export declare type ILoggerRegistryChange = 'append';
/**
 ...
 * Log severity level
 */
export declare type LogLevel = 'critical' | 'error' | 'warning' | 'info' | 'debug';
/**
 ...
 */
export declare type ILogPayload = ITextLog | IHtmlLog | IOutputLog;
export declare type IContentChange = 'append' | 'clear';
export declare type IStateChange = IChangedArgs<IRenderMimeRegistry | null, IRenderMimeRegistry | null, 'rendermime'> | IChangedArgs<LogLevel, LogLevel, 'level'>;
