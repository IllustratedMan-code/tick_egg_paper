 ...
 */
export declare abstract class MutableDataModel extends DataModel {
    /**
...
export declare namespace DataModel {
     ...
     */
    type ChangedArgs = RowsChangedArgs | ColumnsChangedArgs | RowsMovedArgs | ColumnsMovedArgs | CellsChangedArgs | ModelResetArgs;
}
