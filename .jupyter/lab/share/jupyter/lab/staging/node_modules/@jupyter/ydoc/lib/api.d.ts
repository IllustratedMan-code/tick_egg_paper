 ...
 */
export interface ISharedBaseCell<Metadata extends nbformat.IBaseCellMetadata = nbformat.IBaseCellMetadata> extends ISharedText, IObservableDisposable {
    /**
 ...
 */
export type CellChange<MetadataType extends nbformat.IBaseCellMetadata = nbformat.IBaseCellMetadata> = SourceChange & {
    /**
